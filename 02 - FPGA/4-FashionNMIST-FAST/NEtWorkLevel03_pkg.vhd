...
package NetWorkLevel03_pkg is
    component NetWorkLevel03
        Port (
            ...
            Spike_I		: IN std_logic_vector (ML03Y-1   downto 0);
            Spike_O		: out std_logic_vector (ML03X-1   downto 0)
            );
    end component;
end NetWorkLevel03_pkg;

------------------------------------------------------------------
-- Definition des interconnexions -> NetWorkLevel03       		--
------------------------------------------------------------------
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
use IEEE.NUMERIC_STD.ALL;
...
architecture NetWorkLevel03_Full of NetWorkLevel03 is
    ...
    signal LSpike_I   : std_logic_vector (ML03Y-1   downto 0) := (others => '0');
    signal LSpike_O   : std_logic_vector (ML03X-1   downto 0) := (others => '0');
 ...
 begin   
	...
	u1 : for i in 0 to (ML03X-1) generate
                    SRC_one : entity Src_neuro_L03 port map( 

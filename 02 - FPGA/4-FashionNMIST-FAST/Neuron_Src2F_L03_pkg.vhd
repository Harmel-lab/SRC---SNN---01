...
package src_L03_pkg is
	component Src_neuro_L03
		port (
            ...
            Spike_I         : in std_logic_vector (ML03Y-1   downto 0);         -- input spike pulses
...
------------------------------------------------------------------
architecture SRC_all_L03 of Src_neuro_L03 is 
	--------------------------------------------------------------
	...
	constant ML03       : framebuffer_ML03 :=ML03;                      -- matrice de poids 
    signal icur         : integer range 0 to ML03Y := 0;                  -- variable de boucle somme courant

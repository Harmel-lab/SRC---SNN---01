...
package src_L04_pkg is
	component Src_neuro_L04
		port (
            ...
            NumberCell      : integer range 0 to ML04X-1;                       -- numéro de cellule 
            Spike_I         : in std_logic_vector (ML04Y-1   downto 0);         -- input spike pulses
...
------------------------------------------------------------------
architecture SRC_all_L04 of Src_neuro_L04 is 
	--------------------------------------------------------------
	...
	constant ML04       : framebuffer_ML04 :=ML04;                      -- matrice de poids 
    signal icur         : integer range 0 to ML04Y := 0;                -- variable de boucle somme courant

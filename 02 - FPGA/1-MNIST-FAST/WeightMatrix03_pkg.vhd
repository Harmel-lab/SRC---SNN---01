...
package WeightMatrix03 is
    ...
    constant ML03Minval : integer := -8192;    	-- Valeur minimale
    constant ML03Maxval : integer := +8191; 	-- Valeur maximale
    subtype ML03bounded_int is integer range ML03Minval to ML03Maxval;
 
    -- Déclaration de la matrice de poids
    type ML03int_array is array (0 to ML03y-1) of ML03bounded_int;

...
set_property PACKAGE_PIN T4 [get_ports clk_in1_n]
...
create_clock -period 5.000 -name clk_in1_p -waveform {1.000 2.000} [get_ports clk_in1_p]
create_clock -period 5.000 -name clk_in1_n -waveform {1.000 2.000} [get_ports clk_in1_n]
create_clock -period 10240.000 -name VIRTUAL_CLK_Hz -waveform {1000.000 1000.000}
set_input_delay -clock [get_clocks VIRTUAL_CLK_Hz_1] -min -add_delay 400.000 [get_ports switch]
set_input_delay -clock [get_clocks VIRTUAL_CLK_Hz_1] -max -add_delay 400.000 [get_ports switch]

create_generated_clock -name CLK_50MHZ -source [get_pins {clokdiv_reg[1]/C}] -divide_by 1 [get_pins {clokdiv_reg[1]/Q}]
create_generated_clock -name CLK_Hz -source [get_pins {clokdiv_reg[11]/C}] -divide_by 1 [get_pins {clokdiv_reg[11]/Q}]

...
package Neuron_BramInLine_pkg is
	component Neuron_BramInLine
		port (
            ...
            BRMuR_out         : OUT std_logic_vector (0 to 5)                          -- largueur du bus de données muMachine
...
architecture Neuron_BramInLine_all of Neuron_BramInLine is 
	...
	component BramROM_ip is 
	   port (
            ...
            addra           : IN std_logic_vector(10 DOWNTO 0);                  -- bus d'adresse (total 221 registres)
	...
	signal convadd  : std_logic_vector(10 DOWNTO 0);
            ...
            -- processus mode state Machine SmacC --
                ...
                case SmaC is
                    ...
                    when 2 =>
                        ...
                        convadd  <= std_logic_vector(to_unsigned(BRaddr, 11));
                        SmaC<=3;
                    when 3 =>
                        -- réalise un Wait        
                        SmaC<=4;

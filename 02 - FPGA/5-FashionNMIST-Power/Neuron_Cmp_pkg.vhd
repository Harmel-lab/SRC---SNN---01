...
package Cmp_neuro_pkg is   
	component Cmp_neuro
		port (
            ...
            NumberCell      : integer range 0 to ML06X-1;                       -- numéro de cellule 
            Spike_I		    : IN ML06int_array;                                 -- all input spikes
...
architecture Cmp_neuro_all of Cmp_neuro is 
	...
	begin 
		...
		variable tmpcur     : ML06bounded_int :=0;    -- variable de calcul - comparateur

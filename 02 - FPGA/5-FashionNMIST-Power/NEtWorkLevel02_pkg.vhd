...
package NetWorkLevel02_pkg is
    component NetWorkLevel02
        Port (
            ...
            Spike_O		: out std_logic_vector (ML02X-1   downto 0)
            );
    end component;
end NetWorkLevel02_pkg;

------------------------------------------------------------------
-- Definition des interconnexions -> NetWorkLevel02       		--
------------------------------------------------------------------
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
use IEEE.NUMERIC_STD.ALL;
...
architecture NetWorkLevel02_Full of NetWorkLevel02 is
    ...
    signal LSpike_O   : std_logic_vector (ML02X-1   downto 0) := (others => '0');
 ...
 begin   
	...
	u1 : for i in 0 to (ML02X-1) generate
                    SRC_one : entity Src_neuro_L02 port map( 
